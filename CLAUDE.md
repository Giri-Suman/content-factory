...
- [x] P24 catalog into the machine: FormatRegistry (34 formats, drives
      lane routing + Idea Bank rotation), 50-idea seed (deduped),
      CarouselRenderer (7 slides + cover) + DiagramCard (9:16 + 2:3),
      BlogComposer/NewsletterComposer/CommentMiner/Syndication, repurposing
