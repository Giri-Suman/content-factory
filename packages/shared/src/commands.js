...
export const COMMANDS = [
  ...
  { id: "evidence", args: ["quotes"], stage: "find", cat: "all", label: "Community quotes", desc: "real sentences people wrote, attributed", key: "evidence-quotes" },
  ...
  { id: "claims", args: ["map"], argKind: "briefId", stage: "plan", cat: "all", label: "Claims map", desc: "every factual claim and what backs it", primary: true, key: "claims-map" },
  ...
  { id: "edit", args: [], argKind: "file", argLabel: "Path to your footage", stage: "make", cat: "beauty", label: "AI Cut your footage", desc: "silences, filler words, retakes, captions, colour", primary: true, slow: true },
